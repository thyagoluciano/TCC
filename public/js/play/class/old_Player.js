    ...
    Player.prototype = {
        create: function(){
            ...
            if(this.user.equipment){
                if(this.user.equipment.weapon){
                    var tmpWeapon = new EquipFactory(this.game);
                        tmpWeapon.init(this.user.equipment.weapon);

                    this.weapon = tmpWeapon.equip

                    this.player.addChild(this.weapon.dagger);
                }

                if(this.user.equipment.head){
                    var tmpHead = new EquipFactory(this.game);
                        tmpHead.init(this.user.equipment.head);

                    this.head = tmpHead.equip

                    this.player.addChild(this.head.helmet);
                }
        ...
        update: function(){
            ...
            if(direction){
                ...
                if(this.head){
                    this.head.helmet.animations.play(direction);
                }
            }
...
//            var weapon = this.user.equipment.weapon.type;
            ...
            if(this.head){
                this.head.helmet.animations.play(weapon + direction, this.user.attributes.aspd, true);
            }
            if(this.weapon){
                this.weapon.dagger.animations.play(weapon + direction, this.user.attributes.aspd, true);
            }
        },
        ...
        movePlayer: function(){
            ...
            switch (this.user.direction){
                case 'left':
                    this.player.animations.play('left');
                    this.head.helmet.animations.play('left');
                    this.player.body.velocity.x = -150;
                    break;
                case 'right':
                    this.player.animations.play('right');
                    this.head.helmet.animations.play('right');
                    this.player.body.velocity.x = 150;
                    break;
                case 'up':
                    this.player.animations.play('up');
                    this.head.helmet.animations.play('up');
                    this.player.body.velocity.y = -150;
                    break;
                case 'down':
                    this.player.animations.play('down');
                    this.head.helmet.animations.play('down');
                    this.player.body.velocity.y = 150;
                    break;
